    ...
    <div class="container2">
        ...
        <div class="second">
            ...
            <?php       
                        if(!empty($_SESSION['Homeowners_ID'])){
                        $HomeownersID=$_SESSION['Homeowners_ID'];
                        $box1query="SELECT * FROM records WHERE records.homeowners_ID='$HomeownersID' and records.Status='Pending' ";
            ...
            <div class="box">
                ...
                <?php       
                        if(!empty($_SESSION['Homeowners_ID'])){
                        $HomeownersID=$_SESSION['Homeowners_ID'];
                        $box1query="SELECT * FROM complaint WHERE complaint.homeownersID='$HomeownersID' and complaint.Status='Pending' ";
                        $runtest=mysqli_query($conn,$box1query);
                        if($total=mysqli_num_rows($runtest)){
                            echo '<h1> '.$total.' </h1>';
                        }else{
