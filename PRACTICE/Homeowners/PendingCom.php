...
<head>
    ...
    <title>My Pending Complaints</title>
</head>
<body>
    <?php
...
<!----------------------------------------------------------------------------------------------->
    ...
    <div class="container11">
        ...
        ON complaint.homeownersID=homeowners.Homeowners_ID WHERE complaint.homeownersID=$homeownersID and (complaint.Status='Pending' or complaint.Status='In Process') and complaint.forward_status='' ORDER BY complaint.Complaint_ID DESC");
        while($row1=mysqli_fetch_assoc($query)){
        ?>
                <tr>
