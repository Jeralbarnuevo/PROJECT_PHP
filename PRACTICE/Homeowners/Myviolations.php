    ...
    <div class="container11">
        ...
        <table class="table table-bordered table-hover" id="mytable" >
            ...
            <?php
                    ...
                    records.admin_ID = admin.Admin_ID)INNER JOIN violations ON records.violation_ID = violations.ViolationID) WHERE homeowners.Homeowners_ID=$homeownersID and records.Status='Pending' ORDER BY records.records_iD DESC");
                    while($row=mysqli_fetch_assoc($query)){
