...
?>
    ...
    <div class="modal fade" id="updateModal<?php echo $row['ViolationID']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <a href="process.php?update=<?php echo $row['ViolationID'];?>">
                    <button type="submit" name="update" form="form1" class="btn btn-success">Update</button></a>
                </div>
            </div>
        </div>
        </div>
            ...
            <div class="input">
                ...
                <form action="process.php" method="post">
                    ...
                    <div class="box">
                        ...
                        <input type="text" name="ViolationNo" value="<?php echo $code ?>" style="color:red;" readonly required>
                    </div>
                    <div class="box">
