    ...
    <div class="side">
        ...
        <div class="button">
            <ul class="side-button">
                ...
                <a href="Admin-Records.php"><button class="buttn active">
                    <svg class="active" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"><path fill="#fffff" d="M4 9h4v2H4V9z"/><path fill="#fffff" d="M16 2h-1V0H5v2H3v1.25L2.4 4H1v1.75L0 7v9h12l4-5V2zM2 5h8v2H2V5zm9 10H1V8h10v7zm1-8h-1V4H4V3h8v4zm2-2.5l-1 1.25V2H6V1h8v3.5z"/></svg><p>Records</p>
                </button></a>
            </ul>
        </div>
    </div>
...
<div class="tab-content" id="myTabContent">
  ...
  <table class="table table-bordered table-hover" id="Mytable1">
                ...
                <?php
                    ...
                    from records inner join homeowners on records.homeowners_ID = homeowners.Homeowners_ID WHERE records.Status='Pending' ORDER BY records.records_iD DESC");
                    while($row=mysqli_fetch_assoc($query)){
