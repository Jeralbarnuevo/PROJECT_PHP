...
<body>
    <?php
      ...
      if(isset($_POST["login"])){
          ...
          $result=mysqli_query($conn,"SELECT*FROM homeowners WHERE Email='$Email'");
            ...
            <div class="register">
                ...
                <form action="" method="POST" class="mt-3">
                    <div class="col-md-12 mb-2 box1">
                        ...
                        <input type="email" class="form-control" name="Email" autocomplete="0" placeholder="Enter Your Email" required>
                      </div>
                      <div class="col-md-12 mb-2 box1">
