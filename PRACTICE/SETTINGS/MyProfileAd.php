...
<head>
    ...
    <link rel="stylesheet" href="../Homeowners/all.css">
    ...
    <div class="side">
        ...
        <div class="button">
            <ul class="side-button">
                <a href="../Homeowners/Homeowners-dash.php"><button class="buttn">
                ...
                <ul class="drop">
                    <li><a class="dropdown-item" href="../Homeowners/Myviolations.php">Pending Violations</a></li>
                    <li><a class="dropdown-item" href="../Homeowners/closedcomplaint.php">Closed Violations</a></li>
                </ul>
                ...
                <ul class="drop">
                    ...
                    <li><a class="dropdown-item" href="../Homeowners/createcomplaint.php">Create Complaints</a></li>
                    <li><a class="dropdown-item" href="../Homeowners/PendingCom.php">Pending Complaints</a></li>
                    <li><a class="dropdown-item" href="../Homeowners/closedcomplaint.php">Closed Complaints</a></li>
                </ul>
            ...
            <div class="info1">
                <div class="boxA">
                    ...
                    <div class="photo">
                        ...
                        <p style="color:red;"><?php echo $row['Account_Number'] ?></p>
                        </div>
                    </div>
                    <form>
                        <div class="col-sm-6 mb-2 info">
                            <label for="exampleInputEmail1" class="form-label">First Name</label>
                            <input type="email" class="form-control" id="exampleInputEmail1" value="<?php echo $row['First_Name']; ?>" aria-describedby="emailHelp" disabled>
                        </div>
                        <div class="col-sm-6 mb-2 info">
                            <label for="exampleInputPassword1" class="form-label">Last Name</label>
                            <input type="text" value="<?php echo $row['Last_Name']; ?>" class="form-control" id="exampleInputPassword1"disabled>
                        </div>
                        <div class="col-sm-6 mb-2 info">
